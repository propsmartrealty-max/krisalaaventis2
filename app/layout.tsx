  ...
  "@graph": [
    ...
    },
    {
      ...
      "image": [
        ...
        "https://krisalaventis.in/assets/images/2bhk.webp"
      ],
      "sku": "KA-225-839",
      "mpn": "P52100080336-2BHK",
      "brand": {
        "@type": "Brand",
        "name": "Krisala Legacy"
      },
    ...
    },
    {
      ...
      "image": [
        "https://krisalaventis.in/assets/images/hero.webp",
        "https://krisalaventis.in/assets/images/3bhk.webp"
      ],
      "sku": "KA-325-1116",
      "mpn": "P52100080336-3BHK",
      "brand": {
        "@type": "Brand",
        "name": "Krisala Legacy"
      },
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${outfit.variable} ${playfair.variable}`}>
      <head>
        ...
        />
        <link rel="stylesheet" href="/assets/css/style.min.css?v=18" />
      ...
      <body suppressHydrationWarning>
        {children}
        <Script src="/assets/js/script.min.js?v=18" strategy="afterInteractive" />
      </body>
    </html>
  );
}
